...
Create a personal portfolio using HTML/CSS and GitHub Pages that shows off the best parts of your Projects 1, 2, and 3 from this class, and optionally, one additional project you have done in another class or on your own.
...
- If you have a game (as in Project 3) could the game be embedded directly on the website? Will there be screenshots of the game? Could you even have a photo of someone playing the game if you wanted to incorporate the documented experience of the game?

### Instructions

- Create a new repository named "personal-portfolio"
- Inside this repository create a new "index.html" file which will be the main page for your Personal Portfolio
...
- Must be posted on Github Pages no later Tuesday, May 6th
