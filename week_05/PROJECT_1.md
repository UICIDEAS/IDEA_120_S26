...
3. Create two new files in your repository, and save the first as "index.html" ([there's a sample file here](https://github.com/UICIDEAS/IDEA_120_S26/blob/Spring2026/website_demo/index.html) and the second as "style.css" ([a sample file here](https://github.com/UICIDEAS/IDEA_120_S26/blob/Spring2026/website_demo/style.css). Make sure they are in the main folder of your new repository. Use what you learned in the [HTML Tutorial](https://www.w3schools.com/html/default.asp) and [CSS Tutorial](https://www.w3schools.com/css/default.asp) to do Step 4 and 5 from the project description above.
